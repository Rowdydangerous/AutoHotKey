...
if (WinExist("TSheets :: login")){
		...
		if (errorlevel) {
			msgbox, 16, , WinWait Timeout waiting for TSheets login page. , 1
		}
		click, 780, 450
}
If WinExist("TSheets :: "){
...
^+!F1::										;Run Default.ahk
Run, C:\Users\rowdy\Documents\AutoHotKey\Default.ahk
ExitApp

^+!F2::										;Run Owlwise.ahk
Run, C:\Users\rowdy\Documents\AutoHotKey\OwlW1z3.ahk
ExitApp
...
^+!F4::										;Run .ahk
Run, C:\Users\rowdy\Documents\AutoHotKey\Mater IO.ahk
ExitApp
...
+Delete:: 						;Shift Delete to Backspace
send {Backspace}
return
